...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const courseDetails = {
        ...
        enf: { title: "Perfil: O Cuidador Essencial", description: "Você tem empatia e a capacidade de oferecer conforto e cuidado técnico em momentos de necessidade. Sua dedicação faz a diferença.", image: "https://iergs.com.br/wp-content/uploads/2023/11/O-Curso-de-Enfermagem-e-dificil.jpg", strongPoints: ["Empatia", "Cuidado técnico", "Resiliência", "Atenção humanizada"] },
    ...
    const gameData = [
        ...
        { phase: 3, hotspotId: 'hotspot-3-4', questionText: "Você percebe que seu colega de grupo, que é tímido, travou de nervoso. O que você faz?", answers: [{ text: "Faço uma pergunta simples e direta a ele sobre a parte que ele domina, para 'quebrar o gelo'.", points: { enf: 3, cui: 2, rh: 1 } }, { text: "Assumo a fala dele de forma natural, para não quebrar o ritmo da apresentação.", points: { adm: 1 } }, { text: "Sussurro a primeira frase da fala dele para ajudá-lo a lembrar.", points: { enf: 1 } }], fragment: "HA", hint: "Preciso verificar a ultima porta que fica ao final do auditorio." },
        { phase: 3, hotspotId: 'hotspot-3-5', questionText: "O desafio acabou. Você coletou as pistas. É hora de abrir a porta final.", answers: [], fragment: "SENHA", password: "VENHA", hint: "Está trancada. Agora com a senha posso ver a ultima porta." }
    ];
